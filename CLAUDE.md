...
Default to terse, token-efficient prose in chat responses:
...
- Code comments, commit messages, documentation, and any message sent to a third party (email, PR description, Slack, etc.).
